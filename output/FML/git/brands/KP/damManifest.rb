...
module KPManifest
  def associateDAMReferences
    @logo = "#{BRANDS_EXT}/KP/images/logo2.png"
    # these two are from carousel
    @newBusiness = "new quote"
    @quoteSearch = "quote search"
    
    # single line row widget images
    @mandatoryIcon = "#{BRANDS_EXT}/KP/images/star.png"
    @tickIcon = "#{BRANDS_EXT}/KP/images/tick.png"
    @helpIcon = "#{BRANDS_EXT}/KP/images/information.png"

    #teaser images
    @van_teaser = "#{BRANDS_EXT}/KP/images/van_teaser.jpg"
    @pub_teaser = "#{BRANDS_EXT}/KP/images/pub_teaser.jpg"
    @hotel_teaser = "#{BRANDS_EXT}/KP/images/hotel_teaser.jpg"
    @surgery_teaser = "#{BRANDS_EXT}/KP/images/surgery_teaser.jpg"
    
    #images
    @florist_ad = "#{BRANDS_EXT}/KP/images/FloristAdvert.jpg"
