  ...
  def dictionary
    {
      ...
      "employersliabilitycovercoverdetailsuminsured_amount" => "Standard cover for Employers Liability limit is £10,000,000, there is no excess on this coverage.",
      ...
      "generic_search" => "LIST RECENT QUOTES",
      "search_quotes_reference" => "Find quote by reference",
      "search_quotes_name" => "Find quote by client name",
